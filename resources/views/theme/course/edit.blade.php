                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="title" class="form-control" id="basic-default-fullname"
                                    placeholder="Enter Title" required value="{{ $course->title }}" />
                            </div>
                            <div class="mb-3 col-md-6">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="text" id="duration" name="duration" class="form-control"
                                        ...
                                        aria-describedby="basic-default-email2" required value="{{ $course->duration }}" />
                                </div>
                            </div>
                            <div class="mb-3 col-md-6">
                                <label class="form-label" for=" price">price</label>
                                <input type="text" name="price" id="price" class="form-control phone-mask"
                                    placeholder="Enter Price" required value="{{ $course->price }}" />
                            </div>
